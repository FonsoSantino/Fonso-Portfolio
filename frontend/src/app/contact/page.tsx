        ...
        <main className="min-h-screen bg-background text-foreground overflow-hidden pb-24">
            ...
            <div className="relative z-10 container px-4 md:px-6 py-12 md:py-24">
                <div className="flex flex-col items-center text-center space-y-6 mb-20">
                    ...
                    <h1 className="text-5xl md:text-8xl font-black tracking-tighter uppercase italic overflow-visible pr-8">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="p-8 md:p-12 rounded-[3.5rem] bg-card/50 border border-border/50 backdrop-blur-3xl shadow-2xl relative overflow-hidden"
                    >
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    ...
                                    <a
                                        ...
                                        className="p-6 rounded-[2.5rem] bg-card border border-border/50 flex flex-col items-center gap-3 hover:border-primary transition-all hover:scale-105 group"
                                    >
